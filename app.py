...
# ✅ 閉じるボタン付きLINEバナー（PC/スマホ共通・Manage appと干渉なし）
st.markdown("""
<style>
.line-banner-wrap {
  position: fixed;
...
.line-banner:hover { transform: scale(1.03); background: #05b34d; }
...
<div id="line-banner" class="line-banner-wrap">
  <div class="line-banner" role="button" aria-label="LINE公式アカウントを開く">
    <button class="close-btn" onclick="document.getElementById('line-banner').style.display='none';">×</button>
