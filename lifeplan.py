...
if submitted:
    ...
    # 初期値辞書
    initial_vals = [
        securities, foreign, 0, insurance_product, crypto, offshore, fx, deposit, gold
    ]
    asset_balances = {}
    ...
    for y in range(years):
        invest_sum = sum(port_inputs) * 12  # 年間投資積立
        net = surplus[y] - invest_sum
