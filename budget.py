...
# plt.rcParams['font.family'] = 'MS Gothic'   # Windowsの場合はこちら
...
if seller_type == "宅建業者・買取再販" and is_shinchiku:
    ...
    if perf in ["長期優良住宅・低炭素住宅", "ZEH水準省エネ住宅", "省エネ基準適合住宅"]:
        ...
        koujo_limit = 2000
        koujo_years = 10
koujo_years = min(loan_years, koujo_years)  # 借入期間より短く
...
ax2.set_xlabel("年齢", fontname='Hiragino Sans')
ax2.set_ylabel("万円", fontname='Hiragino Sans')
ax2.set_title("資産価値とローン残債の推移", fontname='Hiragino Sans')
ax2.legend(prop={'family':'Hiragino Sans'})
ax2.grid(True)
st.pyplot(fig2)
...
・<b>所得要件：</b>控除を受ける年分の合計所得金額が3,000万円以下であること<br>
